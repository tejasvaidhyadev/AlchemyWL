...
def build_parser():
	...
	parser.add_argument('-project_name', type=str, default='wl-alchemy-iid', help='Name of the project')
	parser.add_argument('-dataset', type=str, default='alchemy_iid', help='Dataset')
